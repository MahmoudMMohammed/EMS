...
class HostSeeder extends Seeder
{
    ...
    {           //1             2        3       4          5         6           7
        ...
        $recommended_for = ['For food gatherings' , 'For small gatherings' , 'For parties with friends' , 'For large meetings' , 'For barbecue parties' , 'For visual presentations' , 'For huge events'];
